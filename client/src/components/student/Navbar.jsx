    ...
    <div className={`flex items-center justify-between px-4 sm:px-10 md:px-14 lg:px-36 border-b border-gray-400 py-3 ${isCourseListPage ? 'bg-white' : 'bg-cyan-100/70'}`}>
      ...
      <div className='hidden md:flex items-center gap-5 text-gray-900'>
        <div className='flex items-center gap-5'>
          {user && <>
            <button className='text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 rounded-xl text-sm px-4 py-2.5 text-center me-2 cursor-pointer' onClick={() => { navigate('/educator') }}>{isEducator ? "Educator Dashboard" : "Become Educator"}</button>
