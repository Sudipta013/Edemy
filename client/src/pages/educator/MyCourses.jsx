...
const MyCourses = () => {
  ...
  return courses ? (
    <div className='h-screen flex flex-col justify-between items-start md:p-8 md:pb-0 p-4 pb-0'>
                ...
                courses.map(course => (
                  <tr key={course._id} className='border-b border-gray-500/20'>
                    <td className='md:px-4 pl-2 md:pl-4 py-3 flex items-center space-x-3 truncate'>
                      <img src={course.courseThumbnail} alt={course.courseName} className='w-16' />
