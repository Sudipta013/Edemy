...
const CoursesSection = () => {
  ...
  return (
    <div className='py-10 sm:py-16 md:px-40 px-8'>
      ...
      <Link to={'/course-list'} onClick={() => window.scrollTo(0, 0)} className='text-gray-500 hover:text-gray-700 border border-gray-500/30 px-10 py-3 rounded'>Show all courses</Link>
    </div>
  )
}
