...
const Hero = () => {
  return (
    <div className='flex flex-col items-center justify-center w-full md:pt-36 pt-20 px-7 md:px-0 space-y-7 text-center bg-gradient-to-b from-cyan-100/70 via-cyan-100 to-white'>
      <h1 className='md:text-[48px] text-[36px] font-bold relative text-gray-800 max-w-3xl mx-auto'>Empower your future with the
      ...
      <p className='md:block hidden text-gray-500 text-sm max-w-2xl mx-auto'>
