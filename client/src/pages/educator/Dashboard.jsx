...
const Dashboard = () => {
  ...
  return dashboardData ? (
    <div className='min-h-screen flex flex-col items-center justify-between gap-8 p-8 md:pb-0 pt-8 pb-0'>
      <div className='space-y-5'>
        ...
        <h2 className='pb-2 text-lg font-semibold text-gray-600'>Recent Enrollments</h2>
            ...
            <tbody className='text-sm text-gray-500'>
              {dashboardData.enrolledStudentsData.map((student, index) => (
                <tr key={index} className='border-b border-gray-500/20'>
                  <td className='px-4 py-3 font-medium text-center hidden sm:table-cell'>{index + 1}</td>
                  ...
                  <td className='md:px-4 px-2 py-3 truncate'>{student.courseTitle}</td>
                </tr>
              ))}
            </tbody>
