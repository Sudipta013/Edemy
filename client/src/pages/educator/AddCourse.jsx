            ...
            <div key={chapterIndex} className='bg-white border rounded-lg mb-4'>
              <div className='flex justify-between items-center p-4 border-b'>
                <div className='flex items-center'>
                  ...
                  <span className='font-semibold'>{chapterIndex + 1}{chapter.chapterTitle ? ` - ${chapter.chapterTitle}` : ''}</span>
                </div>
          ...
          <div onClick={() => handleChapter('add')} className='flex justify-center items-center bg-blue-100 p-2 rounded-lg cursor-pointer'>+ Add Chapter</div>
          {
            showPopup && (
              <div className='fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50'>
                <div className='bg-white text-gray-700 p-4 rounded relative w-full max-w-86'>
                  ...
                  <div className='mb-2'>
                    <p>Is Preview Free?</p>
                    <input type="checkbox" className='mt-1 scale-125' value={lectureDetails.isPreview} onChange={(e) => setLectureDetails({ ...lectureDetails, isPreviewFree: e.target.checked })} />
                  </div>

                  <button onClick={addLecture} type='button' className='w-full bg-blue-500 text-white py-2 rounded px-4 cursor-pointer'>Add</button>
